...
//        expandableViewLevel3.setOutsideContentLayout(topExpandableView.getContentLayout(),
//                expandableViewLevel1.getContentLayout(), expandableViewLevel2.getContentLayout());
    ...
    private void createTopExpandableView() {
        ...
        topExpandableView.fillData(R.mipmap.ic_launcher, getString(R.string.android_names), false);
        addContentView(topExpandableView, "hello", true);
        addContentView(topExpandableView, "hello1111", true);
...
/*
    private void createMiddleExpandableView() {
        ...
        middleExpandableView.fillData(R.mipmap.ic_launcher, getString(R.string.android_names), false);
...
//        expandableViewLevel1.fillData(R.mipmap.ic_launcher, getString(R.string.android_codes), false);
...
//        expandableViewLevel2.fillData(R.mipmap.ic_launcher, getString(R.string.android_names), false);
...
//        expandableViewLevel3.fillData(R.mipmap.ic_launcher, getString(R.string.android_codes), false);
